...
class UserFirebaseController {
  ...
  Future<UserFirebaseModel?> cadastrar(String nome, String email, String senha, String cpf, String telefone,DateTime dataNascimento){
    return _authService.registrarUsuario(nome, email, senha, cpf,telefone, dataNascimento);
  }
