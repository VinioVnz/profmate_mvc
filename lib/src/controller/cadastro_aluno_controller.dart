...
class CadastroAlunoController {
  ...
  //método para criar um aluno a partir dos dados
    ...
    return CadastroAlunoModel(
      ...
      cpfResponsavel: cpfResponsavelController.text.replaceAll(RegExp(r'\D'), ''),
    );
  }
  ...
  valorAulaController.text = aluno.valorAula.toStringAsFixed(2).replaceAll('.', ',');
  nomeResponsavelController.text = aluno.nomeResponsavel ?? '';
  cpfResponsavelController.text = formatarCpfResponsavel.maskText(aluno.cpfResponsavel ?? '');
