...
class FinanceiroController {
  ...
  Future<void> alunoFinanceiro(BuildContext context) async {
    ...
    errorMessage.value = null;
     ...
     List<FinanceiroModel> getAlunosPendentes () { 
      return [
      FinanceiroModel(id: '001', nomeAluno: 'João Silva', vencimento: DateTime(2025, 9, 10), custoAula: 50.0, estaPago: false, fotoUrl: ''),
      FinanceiroModel(id: '002', nomeAluno: 'Maria Souza', vencimento: DateTime(2025, 9, 12), custoAula: 60.0, estaPago: false, fotoUrl: ''),
      FinanceiroModel(id: '003', nomeAluno: 'Lucas Lima', vencimento: DateTime(2025, 9, 15), custoAula: 55.0, estaPago: false, fotoUrl: ''),
      ];
     }
